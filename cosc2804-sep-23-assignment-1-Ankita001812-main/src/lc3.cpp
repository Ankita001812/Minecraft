        ...
        else
        {
            ...
            else if (trapvect == TRAP_PRINT_REGISTERS)
            {
                ...
                printf("R7: %u\n", reg[7]);
                    ...
                    int16_t x1=unsigned_to_signed(reg[0]);
                    int16_t y1=unsigned_to_signed(reg[1]);
                    int16_t z1=unsigned_to_signed(reg[2]);

                    int16_t x2=unsigned_to_signed(reg[3]);
                    int16_t y2=unsigned_to_signed(reg[4]);
                    int16_t z2=unsigned_to_signed(reg[5]);
